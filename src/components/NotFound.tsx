...
export default function NotFound() {
  ...
  return (
    <div className="app-shell bg-white grid grid-cols-[repeat(4,_minmax(0px,_1fr))] relative w-full" data-name="404" data-node-id="633:1944">
      <div className="[grid-area:1_/_1] content-stretch flex flex-col items-start justify-between relative shrink-0 h-full" data-name="left-stack" data-node-id="633:1945">
      ...
      <div className="[grid-area:1_/_2_/_auto_/_span_3] bg-[#0d0d0d] content-stretch flex flex-col items-center overflow-clip relative shrink-0 h-full" data-name="right-stack" data-node-id="633:1956">
